package com.toy.accesscontrol.user.adapter.global.api;
...
public class UserApiResponse<T> {
    ...
    public static <T> UserApiResponse<T> of(T result) {
        return (UserApiResponse<T>) UserApiResponse.builder().result(result).build();
    }
}
